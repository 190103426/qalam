            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <form method="post" action="{{ route('admin.users.store')}}" class="add_product_form" name="add_product_form"
                    ...
                    if (!empty($phone)) {
                                ...
                                <div class="form-group">
                                    <label for="">{{__('Құпия сөз')}} <i class="fa red">*</i></label>
                                    <input type="password"
