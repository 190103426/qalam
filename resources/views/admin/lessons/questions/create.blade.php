                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Сұрақ қосу</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('admin.lessons.questions.store', [
                                                                                'course' => $lesson->module->course_id,
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                id="ckeditor_description"
                                                cols="30" rows="10"
                                                placeholder="">{{old('answer_1')?? ''}}</textarea>
                                            @error('answer_1')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                id="ckeditor_description"
                                                cols="30" rows="10"
                                                placeholder="">{{old('answer_2')?? ''}}</textarea>
                                            @error('answer_2')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                id="ckeditor_description"
                                                cols="30" rows="10"
                                                placeholder="">{{old('answer_3')?? ''}}</textarea>
                                            @error('answer_3')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <!-- <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                id="ckeditor_description"
                                                cols="3" rows="3"
                                                placeholder="">{{old('answer_4')?? ''}}</textarea>
                                            @error('answer_4')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                id="ckeditor_description"
                                                cols="30" rows="10"
                                                placeholder="">{{old('answer_5')?? ''}}</textarea>
                                            @error('answer_5')
                                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                            @enderror
                                        </div> -->
                                        <div class="form-group">
                                            ...
                                            <select name="current_answer_number" id="" class="form-control">
                                                ...
                                                <option value="1" @if (old('current_answer_number') ==1) selected @endif>Жауап A</option>
                                                <option value="2" @if (old('current_answer_number') ==2) selected @endif>Жауап B</option>
                                                <option value="3" @if (old('current_answer_number') ==3) selected @endif>Жауап C</option>
                                                <!-- <option value="4" @if (old('current_answer_number') ==4) selected @endif>Жауап D</option> -->
                                                <!-- <option value="5" @if (old('current_answer_number') ==5) selected @endif>Жауап E</option> -->
                                            </select>
