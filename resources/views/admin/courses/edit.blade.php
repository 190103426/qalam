                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="intro_video"
                                           ...
                                           placeholder="" value="{{$course->intro_video}}">
                                    @error('intro_video')
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
